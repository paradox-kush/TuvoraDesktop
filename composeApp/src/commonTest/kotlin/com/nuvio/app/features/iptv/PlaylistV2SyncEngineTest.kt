...
class PlaylistV2SyncEngineTest {
    ...
    fun `a deleted profile's pending op is discarded and cannot populate a recreated profile`() = runBlocking {
        ...
        // B24 requires us to prevent. On pull, A sees the newer generation, DISCARDS the now-obsolete
        // pending, and pushes nothing.
        ...
        // Legitimately RECREATED at the reused id: a genuinely NEW local op must still sync normally.
