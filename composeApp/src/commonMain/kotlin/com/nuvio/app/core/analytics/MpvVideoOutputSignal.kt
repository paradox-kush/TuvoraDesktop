 ...
 * two platforms whose Android/mpv counters were callback-driven (Android TV, Android mobile).
 * iOS and desktop already advance at read time (`estimated-vf-fps > 0 → ticks++`); this pulls the
