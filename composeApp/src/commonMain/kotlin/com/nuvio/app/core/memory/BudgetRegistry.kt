...
/**
 * The single place that knows the app's total heap ambition. Every in-memory cache is
 * created through here: a name, a tier-sized cap, and a trim callback. Anonymous caches
 * (an LruCache outside the registry) fail review. One pressure listener walks the registry
