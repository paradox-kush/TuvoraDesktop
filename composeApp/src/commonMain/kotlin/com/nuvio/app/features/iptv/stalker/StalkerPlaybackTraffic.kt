...
internal object StalkerPlaybackTraffic {
     ...
     *
     * Field report (S24, 2026-08-16): scrolling a Stalker portal queues dozens of sequential
     * 14-row pages behind the 2-permit gate; switching to an Xtream account on the SAME
     * Cloudflare-throttled host then crawled until that abandoned backlog drained. Same discipline
     * as the deferral above — requests must track what the user is looking at (iptvnator's queue
     * rule) — but as a DROP, not a delay: the work is not merely early, it is unwanted.
     *
