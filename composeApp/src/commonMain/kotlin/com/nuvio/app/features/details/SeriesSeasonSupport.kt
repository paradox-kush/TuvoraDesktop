...
internal data class EpisodeBucket(
    val label: String,
    val fromIndex: Int,
    val untilIndex: Int,
) {
...
/** Seasons at or below this stay a single plain list — bucketing would only add noise. */
internal const val EPISODE_BUCKET_THRESHOLD = 60
internal const val EPISODE_BUCKET_SIZE = 50
...
internal fun List<EpisodeBucket>.bucketContaining(episodeIndex: Int): EpisodeBucket? =
