 ...
 *
 * KMP twin of NuvioTV's CatchUpDialectWalk; the only divergence is that commonMain URLs carry the
 * measured clock-pair offset alone (no IANA-timezone-name path here).
 */
