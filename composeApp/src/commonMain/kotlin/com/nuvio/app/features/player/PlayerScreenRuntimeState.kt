...
internal class PlayerScreenRuntime(
    ...
    // and the refresh looped forever on a live channel. Reset ONLY on a new videoId (channel/content
    // change) or after sustained healthy playback — never on the refresh's own source swap.
