 ...
 *
 *  - **6 hours back** — the docked guide opens one hour in the past ([GuideTimeTravel] anchors at
 ...
 *    own eight-day window ([CatchUpEpgPolicy]).
 ...
 */
internal object XmltvIngestWindow {
     ...
     * must be a real span.
     *
     * Degenerate rows are refused here for the same reason [CatchUpEpgPolicy] refuses them — a
